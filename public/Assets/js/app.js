var AppProcess = (function () {
    ...
    async function updateMediaSenders(track, rtp_senders){
        for(var con_id in peers_connection_ids){
            if(connection_status(peers_connection_ids[con_id])){
    ...
    async function SDPProccess(message, from_connId){
    ...
    return {
        ...
        processClientFunc: async function(data, from_connId){
            await SDPProccess(data, from_connId);
        },
...
var MyApp = (function(){
    ...
    function event_process_for_signaling_server() {
        ...
        socket.on("showFileMessage", function(data){
            var time = new Date();
            varlTime = time.toLocaleString("en-US", {
                hour: "numeric",
                minute: "numeric",
                hour12:true
            });
            var attachFileAreaForOther = document.querySelector(".show-attach-file");
            attachFileAreaForOther.innerHTML += "<dev class='left-align' style='display:flex;align-items:center;'><img src='public/assets/images/other.jpg' style='height:40px;width:40px;' class='caller-image circle'><div style='font-weight:600;margin:0 5px;'>"+data.username+"</div>:<div><a style='color:#007bff;' href='"+data.filePath+"' download>"+data.fileName+"</a></div></div><br/>";
        });
    ...
    function eventHandling(){
        ...
        $("#divUsers").on("dblclick", "vidoe", function(){
    ...
    $(document).on("click", ".share-attach", function(e){
        ...
        attachFileArea.innerHTML += "<dev class='left-align' style='display:flex;align-items:center;'><img src='public/assets/images/other.jpg' style='height:40px;width:40px;' class='caller-image circle'><div style='font-weight:600;margin:0 5px;'>"+user_id+"</div>:<div><a style='color:#007bff;' href='"+attachFilePath+"' download>"+attachFileName+"</a></div></div><br/>";
    ...
    async function startRecording(){
        ...
        new MediaStream([...screenStream.getTracks(), ...audioStream.getTracks()]);
    }
